...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/still-bar-f95f)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/still-bar-f95f
```

A live public deployment of this template is available at [https://still-bar-f95f.templates.workers.dev](https://still-bar-f95f.templates.workers.dev)
